    ...
    <div style={{ minHeight: '100vh', background: bg, color: fg, fontFamily: 'var(--font-ui)', position: 'relative', overflowX: 'hidden' }}>
      ...
      <section className="og-lp-desk-hero" style={{ padding: '140px 56px 80px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center', maxWidth: 1300, margin: '0 auto', minHeight: '100vh' }}>
        ...
        <div>
          ...
          >
            {/* Before */}
            <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'flex-end', justifyContent: 'flex-end', padding: 24, clipPath: `polygon(${sliderPos}% 0, 100% 0, 100% 100%, ${sliderPos}% 100%)` }}>
              <img src="/assets/lp_desk/Before.png" alt="Before" draggable={false} style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', zIndex: 0, pointerEvents: 'none', userSelect: 'none' }} />
            ...
            <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'flex-end', justifyContent: 'flex-start', padding: 24, clipPath: `polygon(0 0, ${sliderPos}% 0, ${sliderPos}% 100%, 0 100%)` }}>
              <img src="/assets/lp_desk/After.png" alt="After" draggable={false} style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', zIndex: 0, pointerEvents: 'none', userSelect: 'none' }} />
